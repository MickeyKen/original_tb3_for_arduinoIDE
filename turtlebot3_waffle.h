...
#define WHEEL_RADIUS                     0.0635           // meter
...
#define ROBOT_RADIUS                     0.153           // meter (BURGER : 0.105, WAFFLE : 0.220)
#define ENCODER_MIN                      -2147483648     // raw
#define ENCODER_MAX                      2147483648      // raw

#define MAX_LINEAR_VELOCITY              0.5   // m/s   (BURGER : 0.22, WAFFLE : 0.25)
#define MAX_ANGULAR_VELOCITY             4.2   // rad/s (BURGER : 2.84, WAFFLE : 1.82)
