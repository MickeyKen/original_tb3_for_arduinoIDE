...
void loop()
{
  ...
  if ((t-tTime[0]) >= (1000 / CONTROL_MOTOR_SPEED_FREQUENCY))
  {
    ...
    //original
    motor_driver.sptcontrolMotor(WHEEL_SEPARATION, spt_goal_velocity);
    tTime[0] = t;
  }
...
//original
void separateVelocityCallback(const geometry_msgs::Twist& spt_vel_msg)
{
  goal_velocity_from_spt[LEFT]  = spt_vel_msg.linear.y;
  goal_velocity_from_spt[RIGHT] = spt_vel_msg.angular.y;

  goal_velocity_from_spt[LEFT]  = constrain(goal_velocity_from_spt[LEFT],  MIN_LINEAR_VELOCITY, MAX_LINEAR_VELOCITY);
  goal_velocity_from_spt[RIGHT] = constrain(goal_velocity_from_spt[RIGHT], MIN_LINEAR_VELOCITY, MAX_LINEAR_VELOCITY);
}
...
void updateGoalVelocity(void)
{
  ...
  //original
  spt_goal_velocity[LEFT] = goal_velocity_from_spt[LEFT];
  spt_goal_velocity[RIGHT] = goal_velocity_from_spt[RIGHT];
