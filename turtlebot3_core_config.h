...
//original
ros::Subscriber<geometry_msgs::Twist> spt_vel_sub("spt_vel", separateVelocityCallback);
...
//origianl
float spt_goal_velocity[WHEEL_NUM] = {0.0, 0.0};
float goal_velocity_from_spt[WHEEL_NUM] = {0.0, 0.0};
